...
const {getAllWholesalers ,deleteUser , getAllProducts , createuser , updateUser , getAllOrders , getOrdersByWholesaler , deleteOrder} = require("../controllers/adminController");
